 ...
 */
function vipindustrial_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter VIP Industrial default saturation level.
	 *
	 * @since VIP Industrial 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'vipindustrial_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.vipindustrial-front-page) .entry-title,
...
.colors-custom .vipindustrial-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.vipindustrial-front-page .panel-content .recent-posts article,
...
.colors-custom.vipindustrial-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters VIP Industrial custom colors CSS.
	 *
	 * @since VIP Industrial 1.0
	 *
	 ...
	 */
	return apply_filters( 'vipindustrial_custom_colors_css', $css, $hue, $saturation );
}
