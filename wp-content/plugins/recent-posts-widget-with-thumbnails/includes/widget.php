...
<div id="rpwwt-<?php echo $args[ 'widget_id' ];?>" class="rpwwt-widget">
	...
	<?php while ( $r->have_posts() ) : $r->the_post(); ?>
		<li<?php 
			...
			if ( ! $hide_title ) {
				?><span class="rpwwt-post-title"><?php if ( $post_title = $this->get_the_trimmed_post_title( $post_title_length ) ) { echo $post_title; } else { the_ID(); } ?></span><div class="rpwwt-post-date"><?php echo get_the_date(); ?></div><?php
			}
			?></a><?php 
			if ( $show_author ) : 
